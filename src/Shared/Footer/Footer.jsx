...
const Footer = () => {
    return (
        <div>
            <footer className="footer  p-10 rounded-t-xl bg-purple-200 text-base-content">
  <nav>
    <h6 className="footer-title text-purple-600">Services</h6> 
  ...
  <nav>
    <h6 className="footer-title text-purple-600">Company</h6> 
    <a className="link link-hover">About us</a>
    <a className="link link-hover">Contact</a>
    <a className="link link-hover">Tourists Spot</a>
    <a className="link link-hover">Facilities</a>
  </nav> 
  <nav>
    <h6 className="footer-title text-purple-600">Legal</h6> 
    <a className="link link-hover">Terms of use</a>
    <a className="link link-hover">Privacy policy</a>
    <a className="link link-hover">Cookie policy</a>
  </nav>
</footer> 
<footer className="footer mb-6 px-10 py-4 border-t rounded-b-xl bg-purple-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p ><span className="font-bold text-xl text-purple-500">DreamTravello</span> <br/>Providing reliable tech since 1992</p>
  </aside> 
